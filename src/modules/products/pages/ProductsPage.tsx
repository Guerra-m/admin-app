...
export const ProductsPage = () => {
  ...
  const { query: unidadesQuery } = useUnidadesMedida();
  ...
  const {
    ...
    startCreate, startEdit, startView,
    onSubmit, onDelete,
    handleImageChange,
    uploadingImage,
    isSubmitting,
  ...
  return (
    <section className="space-y-stack-lg">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-primary font-store">Productos</h1>
      ...
      {!isLoading && !isError && (
        <div className="rounded-xl bg-surface-container-lowest border border-outline-variant shadow-warm overflow-hidden">
          <ProductsTable
            products={data}
